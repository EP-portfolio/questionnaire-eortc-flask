...
class DatabaseManager:
    ...
    def init_database(self):
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            cursor.execute('CREATE INDEX IF NOT EXISTS idx_session_id ON responses(session_id)')
            cursor.execute('CREATE INDEX IF NOT EXISTS idx_question_num ON responses(question_num)')
    ...
    def save_response(self, session_id: str, question_num: int, question_text: str, 
                     score: int, response_text: str, transcript: str = None, 
                     response_type: str = 'manual') -> bool:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                cursor.execute('''
                    ...
                    VALUES (?, ?, ?, ?, ?, ?, ?)
                ''', (session_id, question_num, question_text, score, 
                     response_text, transcript, response_type))
                conn.commit()
            return True
    ...
    def get_session_statistics(self, session_id: str) -> Dict:
        ...
        scores = [r['score'] for r in valid_responses if isinstance(r.get('score'), (int, float))]
